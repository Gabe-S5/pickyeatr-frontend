                    ...
                    <div class="column">
                        <div class="row">
                            <div class="col-xs-9" style="align-self: flex-end">
                                <div class="text-h5" style="margin-bottom: 4px">Log In</div>
                                <div class="text-subtitle2">Find your saved recipes</div>
                            </div>
                            <div>
                                <q-img src="@/assets/kitchenIcon.png" class="gt-xs kitchen-logo" />
                            </div>
                        </div>
                    </div>
                </q-card-section>
                            ...
                            >
                                ...
                                <div class="row items-end text-center text-subtitle2">
                                    <q-btn
                                        ...
                                        >Log In</q-btn
                                    >
                                    <div class="q-ml-sm q-my-xs">Automatically Registers accounts for you.</div>
                                </div>
                            </q-form>
                        </div>
                    </div>
